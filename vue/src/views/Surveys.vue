  ...
  <PageComponent>
    <template v-slot:header>
      <div class="flex justify-between items-center">
        <div class="text-3xl font-bold tracking-tight text-gray-900">Surveys</div>
        <router-link
    ...
    <div v-else class="grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-3">
      ...
      >
        ...
        <div class="flex justify-between items-center mt-3">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 mt-0.5 mr-2 inline-block">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 -mt-0.5 inline-block">
...
async function deleteSurvey(survey: Survey) {
  const confirmed = confirm("Are you sure you want to delete this survey? Operation can't be undone!!");
  if (!confirmed || !survey.id) return;
